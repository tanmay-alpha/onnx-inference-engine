/* @ts-self-types="./crucible_wasm.d.ts" */
 ...
 */
export function runInference(model_bytes, input_data, input_shape) {
  const ptr0 = passArray8ToWasm0(model_bytes, wasm.__wbindgen_malloc);
  const len0 = WASM_VECTOR_LEN;
...
async function __wbg_init(module_or_path) {
  ...
  if (module_or_path === undefined) {
    module_or_path = new URL("crucible_wasm_bg.wasm", import.meta.url);
  }
  const imports = __wbg_get_imports();
