  ...
  head: () => ({
    meta: [
      { title: "Roadmap · Crucible" },
      {
        name: "description",
        content:
          "What's shipped, in progress, and planned for Crucible — from the pure-Rust WASM build to biometric matching and OCR.",
      },
    ...
    <CrucibleLayout>
      <section className="c-container" style={{ maxWidth: 900 }}>
        ...
        <p className="c-muted" style={{ maxWidth: "60ch" }}>
          ...
          engine, what I'm working on now, and the on-device use cases the runtime is being aimed
          at.
        </p>
            ...
            return (
              <div key={status}>
                <div style={{ display: "flex", alignItems: "baseline", gap: 12, marginBottom: 16 }}>
                  <h2 className="c-h2" style={{ fontSize: 22, margin: 0 }}>
                    {STATUS_LABEL[status]}
                  </h2>
                  <span
                    className="mono"
