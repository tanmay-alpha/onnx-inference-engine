...
import { S as Inbox, _ as Lock, a as TriangleAlert, c as Shield } from "../_libs/lucide-react.mjs";
import { c as logFraudTxToDB, t as CrucibleLayout } from "./Layout-CgtWwv96.mjs";
import { n as runFraudDetection } from "./crucible-wasm-DqqGcYC1.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/fraud-DtC3Yk1b.js
...
function FraudPage() {
	...
	const run = async () => {
		...
		try {
			...
			const latency = Number((performance_default.now() - start).toFixed(2));
